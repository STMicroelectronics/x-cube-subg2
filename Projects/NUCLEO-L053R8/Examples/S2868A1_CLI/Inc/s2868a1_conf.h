...
#define S2868A1_RADIO_GPIO_0_EXTI_LINE                       EXTI_LINE_0 /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_0_IRQn                            EXTI0_1_IRQn /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_0_MODE                            RADIO_MODE_GPIO_IN
#define S2868A1_RADIO_GPIO_0_EXTI_MODE                       GPIO_MODE_IT_FALLING /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_0_IT_PRIO                         0 /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_0_IT_SUBPRIO                      0 /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_0_SPEED                           GPIO_SPEED_FREQ_HIGH /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_0_PULL_MODE                       GPIO_NOPULL

/* GPIO1 as IN */
#define S2868A1_RADIO_GPIO_1_PORT                            GPIOA
#define S2868A1_RADIO_GPIO_1_GPIO_CLK_ENABLE()               __HAL_RCC_GPIOA_CLK_ENABLE()
#define S2868A1_RADIO_GPIO_1_PIN                             GPIO_PIN_4
#define S2868A1_RADIO_GPIO_1_EXTI_LINE                       EXTI_LINE_4 /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_1_IRQn                            EXTI4_15_IRQn /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_1_MODE                            RADIO_MODE_GPIO_IN
#define S2868A1_RADIO_GPIO_1_EXTI_MODE                       GPIO_MODE_IT_FALLING /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_1_IT_PRIO                         0 /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_1_IT_SUBPRIO                      0 /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_1_SPEED                           GPIO_SPEED_FREQ_HIGH /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_1_PULL_MODE                       GPIO_NOPULL
...
#define S2868A1_RADIO_GPIO_2_EXTI_LINE                       EXTI_LINE_0 /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_2_IRQn                            EXTI0_1_IRQn /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_2_MODE                            RADIO_MODE_GPIO_IN
#define S2868A1_RADIO_GPIO_2_EXTI_MODE                       GPIO_MODE_IT_FALLING /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_2_IT_PRIO                         0 /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_2_IT_SUBPRIO                      0 /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_2_SPEED                           GPIO_SPEED_FREQ_HIGH /* This value is not used for Input mode */
#define S2868A1_RADIO_GPIO_2_PULL_MODE                       GPIO_NOPULL
...
#define H_EXTI_0                                             S2868A1_RADIO_GPIO_hexti[3]
