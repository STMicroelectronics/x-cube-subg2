...
/* USE_S2915A1_RADIO_GPIO_x is set if the relevant GPIO_x is used for
 * any purpose (Input, Output or EXTI).
 * The actual MODE will be reflected in the s2915a1_conf.h file in
 * S2915A1_RADIO_GPIO_x_MODE macros that assume these possible values:
 *
 * typedef enum
 * {
 ...
 *
 * like defined in s2915a1.h file.
...
#define USE_S2915A1_RADIO_GPIO_0                        1
#define USE_S2915A1_RADIO_GPIO_1                        1
#define USE_S2915A1_RADIO_GPIO_2                        1
#define USE_S2915A1_RADIO_GPIO_3                        1

/* GPIO Mode: Above macros define if a GPIO is used in any mode,
 * the specific MODE in defined the s2915a1_conf.h file
 */

/* S2915A1_RADIO_GPIO define the "main" radio GPIO that must always
