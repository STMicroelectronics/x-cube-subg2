/**
  @page S2868A1_UDP_Server application for S2-LP Expansion Board and STM32 Nucleo Boards
...
------------------------------------
WWARNING: When starting the project from Example Selector in STM32CubeMX and regenerating it
