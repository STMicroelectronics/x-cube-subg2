...
/* CUSTOM_S2LP_RADIO_GPIO_1 is set as EXTI */
#define S2LP_NVIC_GPIO_1_DisableIRQ()	HAL_NVIC_DisableIRQ( CUSTOM_S2LP_RADIO_GPIO_1_IRQn)
#define S2LP_NVIC_GPIO_1_EnableIRQ()	HAL_NVIC_EnableIRQ( CUSTOM_S2LP_RADIO_GPIO_1_IRQn)
...
#define CUSTOM_S2LP_RADIO_SPI_NSS_SPEED                         GPIO_SPEED_FREQ_HIGH
...
/* GPIO1 as EXTI */
#define CUSTOM_S2LP_RADIO_GPIO_1_PORT                            GPIOA
#define CUSTOM_S2LP_RADIO_GPIO_1_GPIO_CLK_ENABLE()               __HAL_RCC_GPIOA_CLK_ENABLE()
#define CUSTOM_S2LP_RADIO_GPIO_1_PIN                             GPIO_PIN_4
#define CUSTOM_S2LP_RADIO_GPIO_1_EXTI_LINE                       EXTI_LINE_4
#define CUSTOM_S2LP_RADIO_GPIO_1_IRQn                            EXTI4_IRQn
#define H_EXTI_4                                             CUSTOM_S2LP_RADIO_GPIO_hexti[0]
#define CUSTOM_S2LP_RADIO_GPIO_1_MODE                            RADIO_MODE_EXTI_IN
#define CUSTOM_S2LP_RADIO_GPIO_1_EXTI_MODE                       GPIO_MODE_IT_RISING
#define CUSTOM_S2LP_RADIO_GPIO_1_IT_PRIO                         0
#define CUSTOM_S2LP_RADIO_GPIO_1_IT_SUBPRIO                      0
#define CUSTOM_S2LP_RADIO_GPIO_1_SPEED                           GPIO_SPEED_FREQ_HIGH /* This value is not used for EXTI mode */
#define CUSTOM_S2LP_RADIO_GPIO_1_PULL_MODE                       GPIO_NOPULL
...
#define CUSTOM_S2LP_RADIO_GPIO_3_IRQn                            EXTI0_IRQn
#define H_EXTI_0                                             CUSTOM_S2LP_RADIO_GPIO_hexti[1]
...
#define CUSTOM_S2LP_RADIO_GPIO_3_IT_SUBPRIO                      1
...
#define CUSTOM_S2LP_RADIO_GPIO_SDN_SPEED                         GPIO_SPEED_FREQ_HIGH
