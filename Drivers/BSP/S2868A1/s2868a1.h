...
typedef enum                                                                                          
{
  ...
  RISING_FALLING,
  DEFAULT  
}S2868A1_RADIO_GPIO_EDGE_Mode;  


typedef enum 
{  
#if (USE_S2868A1_RADIO_GPIO_0 == 1)    
  S2868A1_RADIO_GPIO_0     = 0x00, /*!< GPIO_0 selected */
#endif 
#if (USE_S2868A1_RADIO_GPIO_1 == 1)    
  S2868A1_RADIO_GPIO_1     = USE_S2868A1_RADIO_GPIO_0,
#endif   
#if (USE_S2868A1_RADIO_GPIO_2 == 1)    
  S2868A1_RADIO_GPIO_2     = USE_S2868A1_RADIO_GPIO_0 + USE_S2868A1_RADIO_GPIO_1,
#endif   
#if (USE_S2868A1_RADIO_GPIO_3 == 1)     
  S2868A1_RADIO_GPIO_3     = USE_S2868A1_RADIO_GPIO_0 + USE_S2868A1_RADIO_GPIO_1 + USE_S2868A1_RADIO_GPIO_2,
#endif     
  S2868A1_RADIO_GPIO_SDN   = USE_S2868A1_RADIO_GPIO_0 + USE_S2868A1_RADIO_GPIO_1 + USE_S2868A1_RADIO_GPIO_2+ USE_S2868A1_RADIO_GPIO_3,
}S2868A1_RADIO_GPIO_TypeDef;
...
#define S2868A1_RADIO_SPI_NSS_PIN_LOW()           HAL_GPIO_WritePin(S2868A1_RADIO_SPI_NSS_PORT, S2868A1_RADIO_SPI_NSS_PIN, GPIO_PIN_RESET)
#define S2868A1_RADIO_SPI_NSS_PIN_HIGH()          HAL_GPIO_WritePin(S2868A1_RADIO_SPI_NSS_PORT, S2868A1_RADIO_SPI_NSS_PIN, GPIO_PIN_SET)
#define EEPROM_NSS_PIN_LOW()          HAL_GPIO_WritePin(S2868A1_EEPROM_SPI_CS_PORT, S2868A1_EEPROM_SPI_CS_PIN, GPIO_PIN_RESET)
#define EEPROM_NSS_PIN_HIGH()         HAL_GPIO_WritePin(S2868A1_EEPROM_SPI_CS_PORT, S2868A1_EEPROM_SPI_CS_PIN, GPIO_PIN_SET)
 ...
 * @retval none
 */
int32_t S2868A1_RADIO_BoardSetXO ( uint8_t );
...
/**
  ...
  * @retval Error code
  */
int32_t S2868A1_LED_Init(Led_t Led);   /* Mount R17 resistor to use led  */
